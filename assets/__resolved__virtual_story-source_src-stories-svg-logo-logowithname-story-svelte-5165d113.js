const __resolved__virtual_storySource_srcStoriesSvgLogoLogowithnameStorySvelte = `<script lang="ts">
...
<Hst.Story title="Logo/Logo with name" icon="mdi:cog" {source}>
	{#key key}
		<svg height="95vh" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 150">
			<style>
				#cog {
					fill: #4b8dda;
...
`;
export {
  __resolved__virtual_storySource_srcStoriesSvgLogoLogowithnameStorySvelte as default
};
